...
class Agent_Basket:
    ...
    def start_basketing(self):
        ...
        with sync_playwright() as p:
            ...
            #time.sleep(120) для регистрации в первый раз, зарегаться и ждать окончания выполнения программы
            ...
            for u in urls:
                ...
                page = click(
                    ...
                    user_query="Найди координаты кнопки 'В корзину' в формате [x, y].",
